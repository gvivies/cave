...
class WineController {
    ...
    def save(Wine wineInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'wineInstance.label', default: 'Wine'), wineInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'wineInstance.label', default: 'Wine'), params.id])
                redirect action: "index", method: "GET"
            }
