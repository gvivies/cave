...
<html>
    ...
    <div data-role="page" data-theme="${message(code: 'jquery.data.theme', default: 'c')}" >
		...
		<div data-role="header" data-theme="${message(code: 'jquery.data.theme', default: 'c')}"  data-fullscreen="true">
			...
			<h1><g:message code="wine.show.label.mobile" default="Detail" /></h1>
		</div>
        <div data-role="content">
            ...
            <ol class="property-list wine">
            	...
            	<div class="ui-grid-b">
            		<div class="ui-block-a"><label><g:message code="wine.name.label" default="Name" /> :</label></div>
					<div class="ui-block-b">
					
						<g:fieldValue bean="${wineInstance}" field="name"/>
            	...
            	<div class="ui-grid-b">
            		<div class="ui-block-a"><label><g:message code="wine.region.label" default="Region" /> :</label></div>
					<div class="ui-block-b">
					
						<g:link controller="region" action="show" id="${wineInstance?.region?.id}">${wineInstance?.region?.name?.encodeAsHTML()}</g:link>
