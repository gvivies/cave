...
<html>
    ...
    <body>
        ...
        <div id="content">	
            <h1><g:message code="bottle.edit.label" args="[entityName]" /></h1>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: bottleInstance, field: 'year', 'errors')}">
                                    <g:selectYear name="year" from="${bottleInstance.constraints.year.inList}" value="${bottleInstance?.year}" />
                                </td>
                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: bottleInstance, field: 'yearMin', 'errors')}">
                                    <g:selectYear name="yearMin" from="${bottleInstance.constraints.yearMin.inList}" value="${bottleInstance?.yearMin}" />
                                </td>
                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: bottleInstance, field: 'yearMax', 'errors')}">
                                    <g:selectYear name="yearMax" from="${bottleInstance.constraints.yearMax.inList}" value="${bottleInstance?.yearMax}" />
                                </td>
                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: bottleInstance, field: 'quantity', 'errors')}">
                                    <g:textField name="quantity" value="${fieldValue(bean: bottleInstance, field: 'quantity')}" />
                                </td>
                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: bottleInstance, field: 'purchaseDate', 'errors')}">
                                	<g:textField name="purchaseDate" value="${formatDate(format: 'dd/MM/yyyy', date: bottleInstance?.purchaseDate)}" />
                                </td>
                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name">
