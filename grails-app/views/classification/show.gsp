		...
		<div id="show-classification" class="content scaffold-show" role="main">
			...
			<ol class="property-list classification">
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="classification.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${classificationInstance}" field="name"/></span>
			...
			<g:form url="[resource:classificationInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${classificationInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
